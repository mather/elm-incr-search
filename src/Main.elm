...
view model =
    div []
        [ input [ placeholder "Search...", value model.searchWord, onInput UpdateSearchWord ] []
        , viewCandidateList model.searchWord
        ]


viewCandidateList : String -> Html Msg
viewCandidateList word =
    case word of
        "" ->
            ul [] []
